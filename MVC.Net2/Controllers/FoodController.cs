...
namespace MVC.Net2.Controllers
{
    public class FoodController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,SoLuong,NguonGoc")] Food food)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,SoLuong,NguonGoc")] Food food)
        {
            if (id != food.ID)
            {
                return NotFound();
